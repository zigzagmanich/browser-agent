...
| механика агента | `pytest` — 86 тестов, ~1 минута: заглушки вместо модели, Chrome без окна на синтетических страницах (модалки, календарь, прозрачные чекбоксы, поле с автовозвратом, скрытые фреймы), сквозной прогон цикла | бесплатно |
