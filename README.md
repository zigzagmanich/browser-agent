...
🎬 **Демо-видео:** [агент выполняет задачу в видимом браузере — YouTube](https://youtu.be/FVhf5R7LNiY) · [то же на Google Диске](https://drive.google.com/file/d/1YYj4F9egfyx26gkct_pBvzzV0CDK5uR-/view?usp=drive_link)
...
Полный дневник исследования — [docs/RESEARCH.md](docs/RESEARCH.md): 45 найденных дефектов с цифрами до и после, разбор 29 живых прогонов, эксперименты и решения, которые не сработали.
...
| механика агента | `pytest` — 93 теста, ~1 минута: заглушки вместо модели, Chrome без окна на синтетических страницах (модалки, календарь, прозрачные чекбоксы, поле с автовозвратом, скрытые фреймы), сквозной прогон цикла | бесплатно |
